...
class LoadSpec:
    ...
    **kwargs :
    ...
    def __init__(self, *args, pha_file=None, arf_file=None, rmf_file=None, srm_file=None, srm_custom=None, custom_channel_bins=None, **kwargs):
        ...
        self.instrument_loaders = {"NuSTAR": inst.NustarLoader, "SOLO/STIX": inst.StixLoader, "RHESSI": inst.RhessiLoader, "Solar Orbiter": inst.StixLoader, "CH-2_ORBITER": inst.XsmLoader}
