...
defined_photon_models = {"thermal_abund": ["T_abund", "EM_abund", "Mg", "Al", "Si", "S", "Ca", "Ar"],
                         "f_vth": ["T", "EM"],
                         "thick_fn": ["total_eflux", "index", "e_c"],
                         "thick_warm": ["tot_eflux", "indx", "ec", "plasma_d", "loop_temp", "length"],
                         "thin_fn": ["total_e_flux", "idx", "low_e_c"],}

def thermal_abund(temperature, emission_measure46, Mg, Al, Si, S, Ca, Ar, energies=None):
    ...
    return thermal_emission_abund(energies, temperature, emission_measure, Mg, Al, Si, S, Ca, Ar).value
